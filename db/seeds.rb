...
# cardio = Workout.create(title: "Cardio") #id 1
# strength = Workout.create(title: "Strength") #id 2
# crossfit = Workout.create(title: "CrossFit") #id 3

# sprints = Exercise.create(name: "Sprints", amount: "6x 200 meters", workout_id: cardio.id)
